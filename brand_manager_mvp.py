...
def show_landing_page():
    """Professional modern AI SaaS landing page - fixed HTML rendering"""
    ...
    # Sticky Navigation
    st.markdown("""
        <div style='position: sticky; top: 0; z-index: 1000; background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); border-bottom: 1px solid #E5E7EB; padding: 1rem 2rem; box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.1);'>
            <div style='max-width: 1400px; margin: 0 auto; display: flex; align-items: center; justify-content: space-between;'>
                <div style='display: flex; align-items: center; gap: 0.75rem;'>
                    <div style='font-size: 2rem;'>🎯</div>
                    <div style='font-size: 1.5rem; font-weight: 800; color: #1F2937;'>Brand Manager AI</div>
                </div>
                <div style='color: #6B7280; font-size: 0.875rem; font-weight: 500;'>Your AI-Powered Brand Management Suite</div>
            </div>
        </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <div style='max-width: 1200px; margin: 0 auto; padding: 5rem 2rem 3rem 2rem; text-align: center;'>
            <div style='display: inline-block; background: linear-gradient(135deg, #EFF6FF 0%, #DBEAFE 100%); padding: 0.5rem 1.5rem; border-radius: 2rem; margin-bottom: 2rem; border: 1px solid #BFDBFE;'>
                <span style='color: #1E40AF; font-weight: 600; font-size: 0.875rem; letter-spacing: 0.05em;'>✨ AI-POWERED BRAND MANAGEMENT</span>
            </div>
            <h1 style='font-size: 4rem; font-weight: 900; line-height: 1.1; color: #111827; margin: 0 0 1.5rem 0; letter-spacing: -0.02em;'>Save 100+ Hours<br/>Every Month</h1>
            <p style='font-size: 1.5rem; color: #4B5563; max-width: 800px; margin: 0 auto 2.5rem auto; line-height: 1.6; font-weight: 400;'>From Nielsen data analysis to competitive intelligence, <strong>automate your day-to-day brand management</strong> and focus on strategy instead of spreadsheets.</p>
            <div style='display: flex; gap: 1rem; justify-content: center; align-items: center; margin-bottom: 3rem;'>
                <div style='text-align: center;'><div style='font-size: 2.5rem; font-weight: 800; color: #1F2937;'>$120K+</div><div style='color: #6B7280; font-size: 0.875rem; font-weight: 500;'>Annual Value</div></div>
                <div style='width: 1px; height: 40px; background: #E5E7EB;'></div>
                <div style='text-align: center;'><div style='font-size: 2.5rem; font-weight: 800; color: #1F2937;'>100+</div><div style='color: #6B7280; font-size: 0.875rem; font-weight: 500;'>Hours Saved/Month</div></div>
                <div style='width: 1px; height: 40px; background: #E5E7EB;'></div>
                <div style='text-align: center;'><div style='font-size: 2.5rem; font-weight: 800; color: #1F2937;'>204x</div><div style='color: #6B7280; font-size: 0.875rem; font-weight: 500;'>ROI</div></div>
            </div>
        </div>
    """, unsafe_allow_html=True)
    ...
    # Trust Indicators
    st.markdown("""
        <div style='background: #F9FAFB; border-top: 1px solid #E5E7EB; border-bottom: 1px solid #E5E7EB; padding: 2rem; margin-bottom: 4rem;'>
            <div style='max-width: 1200px; margin: 0 auto; text-align: center;'>
                <div style='color: #6B7280; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 1.5rem; font-weight: 600;'>POWERED BY INDUSTRY-LEADING AI</div>
                <div style='display: flex; justify-content: center; align-items: center; gap: 3rem; flex-wrap: wrap;'>
                    <div style='display: flex; align-items: center; gap: 0.5rem;'><span style='font-size: 1.5rem;'>🤖</span><span style='color: #1F2937; font-weight: 600;'>Claude Sonnet 4.5</span></div>
                    <div style='display: flex; align-items: center; gap: 0.5rem;'><span style='font-size: 1.5rem;'>🔍</span><span style='color: #1F2937; font-weight: 600;'>Real-Time Web Search</span></div>
                    <div style='display: flex; align-items: center; gap: 0.5rem;'><span style='font-size: 1.5rem;'>📊</span><span style='color: #1F2937; font-weight: 600;'>Nielsen • IRI • Circana</span></div>
                    <div style='display: flex; align-items: center; gap: 0.5rem;'><span style='font-size: 1.5rem;'>🎨</span><span style='color: #1F2937; font-weight: 600;'>Gamma.ai Integration</span></div>
                </div>
            </div>
        </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <div style='max-width: 1200px; margin: 0 auto 3rem auto; padding: 0 2rem; text-align: center;'>
            <h2 style='font-size: 2.75rem; font-weight: 800; color: #111827; margin-bottom: 1rem; letter-spacing: -0.02em;'>7 Modules. Unlimited Possibilities.</h2>
            <p style='font-size: 1.25rem; color: #6B7280; max-width: 700px; margin: 0 auto;'>Every tool you need to manage your brand, powered by AI. From data analysis to creative reviews.</p>
        </div>
    """, unsafe_allow_html=True)
    ...
    modules = [
        {
            "icon": "📊", "name": "Data Performance Analysis", "tagline": "Turn raw data into executive insights in seconds",
            "time": "30-65 min", "cost": "$38-108", "value": "$18K-52K",
            "gradient": "linear-gradient(135deg, #EFF6FF 0%, #DBEAFE 100%)", "border": "#3B82F6",
            "capabilities": ["Auto-detects Nielsen, IRI, Circana, Numerator, SPINS data", "Cleans and standardizes syndicated data formats", "Generates executive summaries with key drivers", "Identifies YOY trends and competitive gaps"]
        },
        {
            "icon": "✍️", "name": "Creative Brief Generator", "tagline": "Create strategic briefs that inspire great work",
            "time": "45-90 min", "cost": "$56-150", "value": "$20K-54K",
            "gradient": "linear-gradient(135deg, #FEF3C7 0%, #FDE68A 100%)", "border": "#F59E0B",
            "capabilities": ["Creates comprehensive creative briefs from inputs", "Ensures strategic alignment with brand positioning", "Generates target audience insights", "Defines success metrics and mandatories"]
        },
        {
            "icon": "🎨", "name": "Brand Positioning", "tagline": "Build differentiated positioning frameworks",
            "time": "2-4 hours", "cost": "$150-400", "value": "$9K-24K",
            "gradient": "linear-gradient(135deg, #FCE7F3 0%, #FBCFE8 100%)", "border": "#EC4899",
            "capabilities": ["Develops complete Brand OS frameworks", "Pressure-tests positioning against competitors", "Creates differentiated value propositions", "Ensures internal consistency across elements"]
        },
        {
            "icon": "💡", "name": "Innovation Ideation", "tagline": "Generate breakthrough product concepts",
            "time": "3-6 hours", "cost": "$225-600", "value": "$13K-36K",
            "gradient": "linear-gradient(135deg, #ECFDF5 0%, #D1FAE5 100%)", "border": "#10B981",
            "capabilities": ["Generates 3-5 innovation concepts with packaging", "Addresses current consumer trends (sustainability, wellness)", "Provides go-to-market strategies", "Assesses feasibility and business potential"]
        },
        {
            "icon": "📑", "name": "Presentation Builder", "tagline": "Create Gamma.ai decks in minutes, not hours",
            "time": "60-120 min", "cost": "$75-200", "value": "$27K-72K",
            "gradient": "linear-gradient(135deg, #EDE9FE 0%, #DDD6FE 100%)", "border": "#8B5CF6",
            "capabilities": ["Creates slide-by-slide Gamma.ai prompts", "Structures compelling narratives for executives", "Recommends data visualizations and layouts", "Generates specific talking points per slide"]
        },
        {
            "icon": "🔍", "name": "Competitive Intelligence", "tagline": "Real-time competitor analysis with sources",
            "time": "90-180 min", "cost": "$113-300", "value": "$20K-54K",
            "gradient": "linear-gradient(135deg, #FEE2E2 0%, #FECACA 100%)", "border": "#EF4444",
            "capabilities": ["Searches web for latest competitor campaigns (Q4 2025)", "Cites sources with URLs for verification", "Estimates media spend by channel", "Provides counter-strategy recommendations"]
        },
        {
            "icon": "⭐", "name": "Creative Quality Review", "tagline": "AI-powered creative evaluation and optimization",
            "time": "45-90 min", "cost": "$56-150", "value": "$13K-36K",
            "gradient": "linear-gradient(135deg, #FFF7ED 0%, #FFEDD5 100%)", "border": "#F97316",
            "capabilities": ["Evaluates creative against brand standards", "Assesses message clarity and emotional impact", "Provides specific improvement recommendations", "Generates optimization opportunities"]
        }
    ]
        ...
        for j in range(2):
            if i + j < len(modules):
                ...
                with cols[j]:
                    # Card HTML
                    card_html = f"""
                    <div style='background: white; border: 2px solid {m['border']}; border-radius: 1.5rem; padding: 2.5rem; margin-bottom: 2rem; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1); position: relative; overflow: hidden;'>
                        <div style='position: absolute; top: 0; right: 0; width: 200px; height: 200px; background: {m['gradient']}; border-radius: 0 1.5rem 0 100%; opacity: 0.3;'></div>
                        <div style='position: relative; z-index: 1;'>
                            <div style='font-size: 3.5rem; margin-bottom: 1rem;'>{m['icon']}</div>
                            <h3 style='color: #111827; margin: 0 0 0.5rem 0; font-size: 1.5rem; font-weight: 700; line-height: 1.3;'>{m['name']}</h3>
                            <p style='color: #6B7280; font-size: 0.95rem; margin: 0 0 1.5rem 0; font-weight: 500; line-height: 1.5;'>{m['tagline']}</p>
                            <div style='background: {m['gradient']}; border-radius: 0.75rem; padding: 1.25rem; margin-bottom: 1.5rem; border: 1px solid {m['border']}30;'>
                                <div style='display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; text-align: center;'>
                                    <div><div style='color: #1F2937; font-weight: 700; font-size: 1rem; margin-bottom: 0.25rem;'>⏱️ {m['time']}</div><div style='color: #6B7280; font-size: 0.75rem; font-weight: 500;'>per use</div></div>
                                    <div><div style='color: #1F2937; font-weight: 700; font-size: 1rem; margin-bottom: 0.25rem;'>💵 {m['cost']}</div><div style='color: #6B7280; font-size: 0.75rem; font-weight: 500;'>saved</div></div>
                                    <div><div style='color: #1F2937; font-weight: 700; font-size: 1rem; margin-bottom: 0.25rem;'>📈 {m['value']}</div><div style='color: #6B7280; font-size: 0.75rem; font-weight: 500;'>annual</div></div>
                                </div>
                            </div>
                            <div style='margin-bottom: 0;'>
                                <div style='color: #374151; font-weight: 700; font-size: 0.875rem; margin-bottom: 0.75rem; text-transform: uppercase; letter-spacing: 0.05em;'>Key Capabilities</div>
                                <ul style='margin: 0; padding-left: 1.25rem; color: #4B5563; font-size: 0.875rem; line-height: 1.7;'>
                    """
                    for cap in m['capabilities']:
                        card_html += f"<li style='margin-bottom: 0.5rem;'>{cap}</li>"
                    card_html += """
                                </ul>
                            </div>
                        </div>
    ...
    # ROI Section
    st.markdown("""
        <div style='max-width: 1000px; margin: 4rem auto 4rem auto; padding: 0 2rem;'>
            <div style='background: linear-gradient(135deg, #1F2937 0%, #111827 100%); border-radius: 2rem; padding: 4rem 3rem; text-align: center; position: relative; overflow: hidden; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.2);'>
                ...
                <div style='position: absolute; bottom: -30px; left: -30px; width: 150px; height: 150px; background: rgba(251, 146, 60, 0.1); border-radius: 50%;'></div>
                <div style='position: relative; z-index: 1;'>
                    <h2 style='color: white; margin: 0 0 1rem 0; font-size: 2.5rem; font-weight: 800; letter-spacing: -0.02em;'>Total Annual Value</h2>
                    <div style='color: rgba(255,255,255,0.9); font-size: 1.125rem; margin-bottom: 2rem; font-weight: 500;'>Based on industry-standard brand manager rates and usage patterns</div>
                    <div style='display: inline-block; background: rgba(255,255,255,0.1); backdrop-filter: blur(10px); border: 2px solid rgba(255,255,255,0.2); border-radius: 1.5rem; padding: 2.5rem 4rem; margin-bottom: 2rem;'>
                        <div style='color: #FCD34D; font-size: 4rem; font-weight: 900; line-height: 1; margin-bottom: 0.5rem;'>$120K - $668K</div>
                        <div style='color: rgba(255,255,255,0.9); font-size: 1.25rem; font-weight: 600;'>in value generated annually</div>
                    </div>
                    <div style='display: flex; justify-content: center; gap: 3rem; margin-bottom: 2rem; flex-wrap: wrap;'>
                        <div><div style='color: #60A5FA; font-size: 2rem; font-weight: 800;'>100+</div><div style='color: rgba(255,255,255,0.8); font-size: 0.875rem;'>Hours Saved/Month</div></div>
                        <div><div style='color: #34D399; font-size: 2rem; font-weight: 800;'>204x</div><div style='color: rgba(255,255,255,0.8); font-size: 0.875rem;'>Return on Investment</div></div>
                        <div><div style='color: #F59E0B; font-size: 2rem; font-weight: 800;'>$588</div><div style='color: rgba(255,255,255,0.8); font-size: 0.875rem;'>Annual Pro Cost</div></div>
                    </div>
                    <div style='color: rgba(255,255,255,0.7); font-size: 0.875rem; font-style: italic;'>Focus on strategy. Let AI handle the spreadsheets.</div>
                </div>
            </div>
        </div>
    """, unsafe_allow_html=True)
    ...
    # CTA Section
    st.markdown("""
        <div style='max-width: 800px; margin: 5rem auto 3rem auto; padding: 0 2rem; text-align: center;'>
            <h2 style='color: #111827; font-size: 2.75rem; font-weight: 800; margin-bottom: 1rem; letter-spacing: -0.02em;'>Ready to 10x Your Productivity?</h2>
            <p style='color: #6B7280; font-size: 1.25rem; margin-bottom: 2.5rem; line-height: 1.6;'>Start with our <strong>Free plan</strong> (5 analyses/month) or unlock all 7 modules with <strong>Pro</strong>.</p>
        </div>
    """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        st.markdown("<div style='text-align: center; margin-top: 1.5rem; color: #9CA3AF; font-size: 0.875rem;'>💳 No credit card required • 🔒 Enterprise-grade security</div>", unsafe_allow_html=True)
    
    # Footer
    st.markdown("""
        <div style='background: #F9FAFB; border-top: 1px solid #E5E7EB; margin-top: 5rem; padding: 3rem 2rem 2rem 2rem;'>
            <div style='max-width: 1200px; margin: 0 auto;'>
                <div style='display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 2rem; margin-bottom: 2rem;'>
                    <div>
                        <div style='display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1rem;'><span style='font-size: 1.5rem;'>🎯</span><span style='font-weight: 700; color: #1F2937;'>Brand Manager AI</span></div>
                        <p style='color: #6B7280; font-size: 0.875rem; line-height: 1.6;'>AI-powered brand management tools for modern brand managers.</p>
                    </div>
                    <div>
                        <div style='font-weight: 700; color: #1F2937; margin-bottom: 0.75rem; font-size: 0.875rem;'>PRODUCT</div>
                        <div style='color: #6B7280; font-size: 0.875rem; line-height: 2;'>Data Analysis<br/>Creative Briefs<br/>Brand Positioning<br/>Innovation</div>
                    </div>
                    <div>
                        <div style='font-weight: 700; color: #1F2937; margin-bottom: 0.75rem; font-size: 0.875rem;'>FEATURES</div>
                        <div style='color: #6B7280; font-size: 0.875rem; line-height: 2;'>Presentation Builder<br/>Competitive Intel<br/>Creative Review<br/>Gamma Integration</div>
                    </div>
                    <div>
                        <div style='font-weight: 700; color: #1F2937; margin-bottom: 0.75rem; font-size: 0.875rem;'>POWERED BY</div>
                        <div style='color: #6B7280; font-size: 0.875rem; line-height: 2;'>Claude Sonnet 4.5<br/>Real-Time Web Search<br/>Syndicated Data Support<br/>Enterprise Security</div>
                    </div>
                </div>
                <div style='border-top: 1px solid #E5E7EB; padding-top: 2rem; text-align: center;'>
                    <div style='color: #9CA3AF; font-size: 0.875rem;'>© 2025 Brand Manager AI. All rights reserved. | Powered by Claude Sonnet 4.5</div>
                </div>
            </div>
        </div>
    """, unsafe_allow_html=True)
...
# ============================================================================
    ...
    # Hero Section - Modern, Bold, Clean
    st.markdown("""
        <div class='fade-in-up' style='max-width: 1200px; 
            ...
            <div style='display: inline-block; 
                ...
                <span style='color: #1E40AF; font-weight: 600; font-size: 0.875rem; letter-spacing: 0.05em;'>
            ...
            <p style='font-size: 1.5rem; 
                     ...
                     line-height: 1.6;
                     font-weight: 400;'>
                From Nielsen data analysis to competitive intelligence, <strong>automate your day-to-day brand management</strong> and focus on strategy instead of spreadsheets.
            </p>
            ...
            <div style='display: flex; 
                       ...
                       margin-bottom: 3rem;'>
                <div style='text-align: center;'>
                    <div style='font-size: 2.5rem; font-weight: 800; color: #1F2937;'>$120K+</div>
                    <div style='color: #6B7280; font-size: 0.875rem; font-weight: 500;'>Annual Value</div>
                </div>
                <div style='width: 1px; height: 40px; background: #E5E7EB;'></div>
                <div style='text-align: center;'>
                    <div style='font-size: 2.5rem; font-weight: 800; color: #1F2937;'>100+</div>
                    <div style='color: #6B7280; font-size: 0.875rem; font-weight: 500;'>Hours Saved/Month</div>
                </div>
                <div style='width: 1px; height: 40px; background: #E5E7EB;'></div>
                <div style='text-align: center;'>
                    <div style='font-size: 2.5rem; font-weight: 800; color: #1F2937;'>204x</div>
                    <div style='color: #6B7280; font-size: 0.875rem; font-weight: 500;'>ROI</div>
                </div>
            </div>
        </div>
    """, unsafe_allow_html=True)
            ...
            <div style='max-width: 1200px; margin: 0 auto; text-align: center;'>
                ...
                <div style='display: flex; 
                    ...
                    <div style='display: flex; align-items: center; gap: 0.5rem;'>
                        ...
                        <span style='color: #1F2937; font-weight: 600;'>Claude Sonnet 4.5</span>
                    </div>
                    <div style='display: flex; align-items: center; gap: 0.5rem;'>
                        <span style='font-size: 1.5rem;'>🔍</span>
                        <span style='color: #1F2937; font-weight: 600;'>Real-Time Web Search</span>
                    </div>
                    <div style='display: flex; align-items: center; gap: 0.5rem;'>
                        <span style='font-size: 1.5rem;'>📊</span>
                        <span style='color: #1F2937; font-weight: 600;'>Nielsen • IRI • Circana</span>
                    </div>
                    <div style='display: flex; align-items: center; gap: 0.5rem;'>
                        <span style='font-size: 1.5rem;'>🎨</span>
                        <span style='color: #1F2937; font-weight: 600;'>Gamma.ai Integration</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    st.markdown("""
        <div style='max-width: 1200px; margin: 0 auto 3rem auto; padding: 0 2rem; text-align: center;'>
            <h2 style='font-size: 2.75rem; 
                      ...
                      margin-bottom: 1rem;
                      letter-spacing: -0.02em;'>
                7 Modules. Unlimited Possibilities.
            </h2>
            <p style='font-size: 1.25rem; color: #6B7280; max-width: 700px; margin: 0 auto;'>
                Every tool you need to manage your brand, powered by AI. From data analysis to creative reviews.
            </p>
        </div>
    """, unsafe_allow_html=True)
    ...
    modules_data = [
        {
            ...
            "tagline": "Turn raw data into executive insights in seconds",
            "time_saved": "30-65 min",
            "cost_saved": "$38-108",
            "annual_value": "$18K-52K",
            "tasks": [
                "Auto-detects Nielsen, IRI, Circana, Numerator, SPINS data",
                "Cleans and standardizes syndicated data formats",
                "Generates executive summaries with key drivers",
                "Identifies YOY trends and competitive gaps"
            ],
        ...
        },
        {
            ...
            "tagline": "Create strategic briefs that inspire great work",
            "time_saved": "45-90 min",
            "cost_saved": "$56-150",
            "annual_value": "$20K-54K",
            "tasks": [
                "Creates comprehensive creative briefs from inputs",
                "Ensures strategic alignment with brand positioning",
                "Generates target audience insights",
                "Defines success metrics and mandatories"
            ],
        ...
        },
        {
            ...
            "tagline": "Build differentiated positioning frameworks",
            "time_saved": "2-4 hours",
            "cost_saved": "$150-400",
            "annual_value": "$9K-24K",
            "tasks": [
                "Develops complete Brand OS frameworks",
                "Pressure-tests positioning against competitors",
                "Creates differentiated value propositions",
                "Ensures internal consistency across elements"
            ],
        ...
        },
        {
            ...
            "tagline": "Generate breakthrough product concepts",
            "time_saved": "3-6 hours",
            "cost_saved": "$225-600",
            "annual_value": "$13K-36K",
            "tasks": [
                "Generates 3-5 innovation concepts with packaging",
                "Addresses current consumer trends (sustainability, wellness)",
                "Provides go-to-market strategies",
                "Assesses feasibility and business potential"
            ],
        ...
        },
        {
            ...
            "tagline": "Create Gamma.ai decks in minutes, not hours",
            "time_saved": "60-120 min",
            "cost_saved": "$75-200",
            "annual_value": "$27K-72K",
            "tasks": [
                "Creates slide-by-slide Gamma.ai prompts",
                "Structures compelling narratives for executives",
                "Recommends data visualizations and layouts",
                "Generates specific talking points per slide"
            ],
        ...
        },
        {
            ...
            "tagline": "Real-time competitor analysis with sources",
            "time_saved": "90-180 min",
            "cost_saved": "$113-300",
            "annual_value": "$20K-54K",
            "tasks": [
                "Searches web for latest competitor campaigns (Q4 2025)",
                "Cites sources with URLs for verification",
        ...
        },
        {
            ...
            "tagline": "AI-powered creative evaluation and optimization",
            "time_saved": "45-90 min",
            "cost_saved": "$56-150",
            "annual_value": "$13K-36K",
            "tasks": [
                "Evaluates creative against brand standards",
                "Assesses message clarity and emotional impact",
    ...
    # Display modules in premium cards
            ...
            if i + j < len(modules_data):
                ...
                with col:
                    st.markdown(f"""
                        <div style='background: white; 
                            ...
                            <div style='position: relative; z-index: 1;'>
                                ...
                                <!-- Metrics -->
                                <div style='background: {module['gradient']}; 
                                           border-radius: 0.75rem; 
                                           padding: 1.25rem; 
                                           margin-bottom: 1.5rem;
                                           border: 1px solid {module['border']}30;'>
                                    <div style='display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; text-align: center;'>
                                        <div>
                                            <div style='color: #1F2937; font-weight: 700; font-size: 1rem; margin-bottom: 0.25rem;'>
                                                ⏱️ {module['time_saved']}
                                            </div>
                    ...
                    for task in module['tasks']:
                        st.markdown(f"<li style='margin-bottom: 0.5rem;'>{task}</li>", unsafe_allow_html=True)
            ...
            <div style='background: linear-gradient(135deg, #1F2937 0%, #111827 100%); 
                ...
                <div style='position: relative; z-index: 1;'>
                    ...
                    <div style='color: rgba(255,255,255,0.9); 
                               ...
                               margin-bottom: 2rem;
                               font-weight: 500;'>
                        Based on industry-standard brand manager rates and usage patterns
                    </div>
                    ...
                    <div style='display: flex; 
                               ...
                               flex-wrap: wrap;'>
                        <div>
                            <div style='color: #60A5FA; font-size: 2rem; font-weight: 800;'>100+</div>
                            <div style='color: rgba(255,255,255,0.8); font-size: 0.875rem;'>Hours Saved/Month</div>
                        </div>
                        <div>
                            <div style='color: #34D399; font-size: 2rem; font-weight: 800;'>204x</div>
                            <div style='color: rgba(255,255,255,0.8); font-size: 0.875rem;'>Return on Investment</div>
                        </div>
                        <div>
                            <div style='color: #F59E0B; font-size: 2rem; font-weight: 800;'>$588</div>
                            <div style='color: rgba(255,255,255,0.8); font-size: 0.875rem;'>Annual Pro Cost</div>
                        </div>
                    </div>
                    ...
                    <div style='color: rgba(255,255,255,0.7); 
                               font-size: 0.875rem; 
                               font-style: italic;'>
                        Focus on strategy. Let AI handle the spreadsheets.
                    </div>
                </div>
            </div>
        </div>
    ...
    st.markdown("""
        <div style='max-width: 800px; 
            ...
            <p style='color: #6B7280; 
                     ...
                     line-height: 1.6;'>
                Start with our <strong>Free plan</strong> (5 analyses/month) or unlock all 7 modules with <strong>Pro</strong>.
            </p>
        </div>
    """, unsafe_allow_html=True)
            ...
            <div style='max-width: 1200px; margin: 0 auto;'>
                <div style='display: grid; 
                    ...
                    <div>
                        <div style='display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1rem;'>
                            <span style='font-size: 1.5rem;'>🎯</span>
                            <span style='font-weight: 700; color: #1F2937;'>Brand Manager AI</span>
                        </div>
                        <p style='color: #6B7280; font-size: 0.875rem; line-height: 1.6;'>
                            AI-powered brand management tools for modern brand managers.
                        </p>
                    </div>
                    
                    <div>
                        <div style='font-weight: 700; color: #1F2937; margin-bottom: 0.75rem; font-size: 0.875rem;'>
                            PRODUCT
                        </div>
                        <div style='color: #6B7280; font-size: 0.875rem; line-height: 2;'>
                            Data Analysis<br/>
                            Creative Briefs<br/>
                ...
                <div style='border-top: 1px solid #E5E7EB; 
                    ...
                    <div style='color: #9CA3AF; font-size: 0.875rem;'>
                        © 2025 Brand Manager AI. All rights reserved. | Powered by Claude Sonnet 4.5
                    </div>
                </div>
            </div>
        </div>
