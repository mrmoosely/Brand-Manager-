...
def show_landing_page():
    """Professional landing page showcasing value proposition and ROI"""
    ...
    st.markdown("""
        <div style='background: linear-gradient(135deg, #1E3A8A 0%, #2563EB 100%); 
            ...
            <h1 style='color: white; margin: 0; font-size: 3.5rem; font-weight: 800; line-height: 1.2;'>
                Brand Manager AI
            </h1>
            ...
            <p style='color: rgba(255,255,255,0.9); 
                     ...
                     margin-left: auto;
                     margin-right: auto;'>
                From Nielsen data analysis to competitive intelligence, automate your day-to-day brand management 
                tasks and focus on strategy instead of spreadsheets.
            </p>
        </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <div style='background: linear-gradient(135deg, #F0FDF4 0%, #DCFCE7 100%); 
            ...
            <h2 style='color: #065F46; text-align: center; margin-top: 0; font-size: 2rem;'>
                💰 Your ROI: Save $120K-$668K Annually
            </h2>
            <div style='text-align: center; color: #047857; font-size: 1.25rem; font-weight: 600; margin-top: 1.5rem;'>
                Platform Cost: $588/year (Pro Plan) | ROI: 204x - 1,137x
            </div>
            <div style='text-align: center; color: #059669; font-size: 1rem; margin-top: 1rem;'>
                Based on brand manager time valued at $75-100/hour
            </div>
        </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <h2 style='color: #1F2937; text-align: center; margin-bottom: 2rem; font-size: 2.25rem;'>
            Time & Cost Savings by Module
        </h2>
    """, unsafe_allow_html=True)
    ...
    modules_data = [
        {
            ...
            "time_saved": "30-65 min per analysis",
            "cost_saved": "$38-108 per analysis",
            "annual_value": "$18K-52K/year",
            "tasks": [
        ...
        },
        {
            ...
            "time_saved": "45-90 min per brief",
            "cost_saved": "$56-150 per brief",
            "annual_value": "$20K-54K/year",
            "tasks": [
        ...
        },
        {
            ...
            "time_saved": "2-4 hours per workshop",
            "cost_saved": "$150-400 per session",
            "annual_value": "$9K-24K/year",
            "tasks": [
        ...
        },
        {
            ...
            "time_saved": "3-6 hours per session",
            "cost_saved": "$225-600 per session",
            "annual_value": "$13K-36K/year",
            "tasks": [
        ...
        {
            "icon": "📑",
            "name": "Presentation Builder (Gamma Prompts)",
            "time_saved": "60-120 min per deck",
            "cost_saved": "$75-200 per deck",
            "annual_value": "$27K-72K/year",
            "tasks": [
        ...
        },
        {
            ...
            "time_saved": "90-180 min per analysis",
            "cost_saved": "$113-300 per analysis",
            "annual_value": "$20K-54K/year",
            "tasks": [
        ...
        },
        {
            ...
            "time_saved": "45-90 min per review",
            "cost_saved": "$56-150 per review",
            "annual_value": "$13K-36K/year",
            "tasks": [
                ...
                with col:
                    st.markdown(f"""
                        <div style='background: white; 
                            ...
                            <h3 style='color: #1F2937; text-align: center; margin-top: 0; font-size: 1.25rem;'>
                                {module['name']}
                            </h3>
                            <div style='background: #EFF6FF; 
                                ...
                                <div style='color: #1E40AF; font-weight: 700; margin-bottom: 0.5rem;'>
                                    ⏱️ {module['time_saved']}
                                </div>
                                <div style='color: #2563EB; font-weight: 600; margin-bottom: 0.5rem;'>
                                    💵 {module['cost_saved']}
                                </div>
                                <div style='color: #1E3A8A; font-weight: 800; font-size: 1.125rem;'>
                                    📈 {module['annual_value']}
                                </div>
                            </div>
                            <div style='color: #4B5563; font-size: 0.875rem; line-height: 1.6;'>
                                <strong style='color: #1F2937;'>Key Capabilities:</strong>
                                <ul style='margin-top: 0.5rem; margin-bottom: 0; padding-left: 1.25rem;'>
                    """, unsafe_allow_html=True)
                    
                    for task in module['tasks']:
                        st.markdown(f"<li style='margin-bottom: 0.25rem;'>{task}</li>", unsafe_allow_html=True)
    ...
    st.markdown("""
        <div style='background: linear-gradient(135deg, #FEF3C7 0%, #FDE68A 100%); 
                    ...
                    text-align: center;'>
            <h2 style='color: #92400E; margin-top: 0; font-size: 2rem;'>
                🎯 Total Annual Value
            </h2>
            <div style='color: #B45309; font-size: 2.5rem; font-weight: 800; margin: 1.5rem 0;'>
                $120K - $668K per year
            </div>
            <div style='color: #D97706; font-size: 1.25rem; font-weight: 600;'>
                100+ hours saved per month | Focus on strategy, not spreadsheets
            </div>
        </div>
    """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
            <div style='text-align: center; margin-bottom: 2rem;'>
                <h3 style='color: #1F2937; margin-bottom: 1rem;'>Ready to 10x your productivity?</h3>
                <p style='color: #6B7280; margin-bottom: 1.5rem;'>
                    Start with our Free plan (5 analyses/month) or unlock all 7 modules with Pro.
                </p>
            </div>
        """, unsafe_allow_html=True)
        ...
        st.markdown("<div style='text-align: center; margin-top: 1rem; color: #6B7280;'>Select a module from the sidebar to get started →</div>", unsafe_allow_html=True)
