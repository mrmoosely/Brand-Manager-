...
ADDITIONALLY: After the analysis, create a copy-paste ready prompt for Gamma.ai or Beautiful.ai.
...
Create a [number] slide business review presentation on this performance analysis.

Objective: [Clear presentation objective]

Style: Professional, data-driven, executive-focused
Color scheme: Navy blue and white, or corporate colors

Slide-by-slide content:

1. [Slide Title]: [Message-forward headline]
   - [Key metric 1]
   - [Key metric 2]
   - [Key metric 3]
   Include: [Chart type - bar chart, line graph, etc.]

2. [Slide Title]: [Message-forward headline]
   - [Key points]
   Include: [Visuals]

[Continue for all recommended slides - typically 8-12 for business review]

Visual style: Clean, professional, executive-appropriate
Tone: Confident, achievement-focused, data-driven

═══════════════════════════════════════════════════════════════════════════

Make it complete and copy-paste ready with all key data points."""
