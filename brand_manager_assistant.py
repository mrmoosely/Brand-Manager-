...
class BrandManagerAssistant:
    ...
    def analyze_market_data(self, data_file=None, data_dict=None, analysis_focus=None, generate_ai_prompt=False, reference_context=None):
        """
        ...
        Args:
            ...
            reference_context: Optional text from uploaded reference files (brand guidelines, past analyses, etc.)
        """
...
If reference materials (brand guidelines, past analyses, etc.) are provided, use them to:
- Align recommendations with brand strategy
- Reference past performance patterns
- Maintain consistency with brand voice and priorities
- Tailor insights to specific brand context
...
The user has provided the following reference materials to inform your analysis:

{reference_context}

Please use these materials to:
- Align analysis with brand guidelines and strategy
- Reference relevant past performance or initiatives
- Maintain brand voice and priorities
...
Provide a comprehensive performance analysis with clear drivers and actionable recommendations.{ai_prompt_instruction}"""
    ...
    def generate_creative_brief(self, template_file=None, brief_inputs=None, generate_ai_prompt=False, reference_context=None):
        """
...
Use these materials to inform and align your output with the brand's established guidelines, past work, and strategic context.
"""
...
Create a comprehensive, actionable creative brief that will inspire great work.{ai_prompt_instruction}"""
    ...
    def develop_brand_positioning(self, brand_os_inputs=None, positioning_challenge=None, generate_ai_prompt=False, reference_context=None):
        """
...
Create a comprehensive Brand OS with clear strategic rationale.{ai_prompt_instruction}"""
    ...
    def generate_innovation_ideas(self, innovation_brief=None, category=None, target=None, constraints=None, generate_ai_prompt=False, reference_context=None):
        """
...
Create a complete deck structure with slide-by-slide content and recommendations.{ai_prompt_instruction}"""
    ...
    def analyze_competitor(self, competitor_brand, user_brand=None, category=None, focus_areas=None, generate_ai_prompt=False, reference_context=None):
        """
...
Be specific with numbers, show your reasoning, and indicate confidence levels."""
    ...
    def review_creative_asset(self, creative_description, objective, target_consumer, 
                            medium, brand_context=None, generate_ai_prompt=False, reference_context=None):
        """
